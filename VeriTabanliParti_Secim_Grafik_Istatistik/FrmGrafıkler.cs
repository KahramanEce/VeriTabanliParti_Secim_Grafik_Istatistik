...
{
    public partial class FrmGrafıkler : Form
    {
        public FrmGrafıkler()
        {
            InitializeComponent();
        }
        SqlConnection baglanti = new SqlConnection(@"Data Source = ECE\SQLSV; Initial Catalog = DBSECIMPROJE; Integrated Security = True");
        private void FrmGrafıkler_Load(object sender, EventArgs e)
        {
